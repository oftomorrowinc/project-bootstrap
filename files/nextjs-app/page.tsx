  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8 py-12">
      ...
      <div className="max-w-3xl text-center">
        <p className="mb-4">
          This template includes Firebase App Hosting, Firestore, dark theme support, 
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
        ...
        >
          <h2 className="text-xl font-semibold mb-2 group-hover:text-blue-500">
            NextJS Docs <span className="inline-block transition-transform group-hover:translate-x-1">→</span>
          </h2>
        ...
        >
          <h2 className="text-xl font-semibold mb-2 group-hover:text-orange-500">
            Firebase Docs <span className="inline-block transition-transform group-hover:translate-x-1">→</span>
          </h2>
